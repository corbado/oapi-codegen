...
//
// Code generated by github.com/corbado/oapi-codegen version (devel) DO NOT EDIT.
...
type Client struct {
	...
	// https://api.corbado.com for example. This can contain a path relative
	// to the server, such as https://api.corbado.com/dev-test, and all the
