...
We use similar code in production at Corbado, and this example shows how authenticated
...
First, we need to configure our [OapiRequestValidator](https://github.com/corbado/oapi-codegen/blob/master/pkg/middleware/oapi_validate.go)
